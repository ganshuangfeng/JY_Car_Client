...
RoadBarrierLandmine = basefunc.class(RoadBarrierBase)
local M = RoadBarrierLandmine
M.name = "RoadBarrierLandmine"
...
function M:ctor(data)
    RoadBarrierLandmine.super.ctor(self,data)
end
...
function M:SetEnemyMeStyle()
    ...
    if DriveModel.CheckOwnerIsMe(self.road_barrier_data) then
        local mesh_renderer  = self.transform:Find("luzhang/@item_img/dilei"):GetComponent("MeshRenderer")
