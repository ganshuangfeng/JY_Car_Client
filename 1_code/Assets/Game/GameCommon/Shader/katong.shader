...
Shader "MyUnlit/CartoonShading"
{
    Properties
    {
        ...
        _Night("_Night",Range(0.8,1)) = 1
        //_SecondLightMap("_SecondLightMap",2D) = "white"{}
    }
    SubShader
    {
        Tags {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i):SV_Target
            {
                ...
                _Blend_Shadow = 0.5;
                black.rgb *= lightmapColor;
                col.rgb *= lightmapColor;
                _Blend_Shadow = (1 - _Night) * 3 + 0.5 ;
                return (fixed4(ambient+diffuse+specular,1.0) * shadow * _Blend_Shadow +  col * (1 - _Blend_Shadow)) * _Night + black * (1 - _Night);
            }
            ENDCG
        }
