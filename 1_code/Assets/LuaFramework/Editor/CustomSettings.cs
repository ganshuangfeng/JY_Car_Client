...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(DG.Tweening.Core.Easing.EaseManager)),
		...
		_GT(typeof(UnityEngine.SortingLayer)),
		_GT(typeof(ReplaceBakingMap)),
		_GT(typeof(DrawMesh)),
        ...
        //effect
        _GT(typeof(ScreenRain)),
        _GT(typeof(ScreenBroken)),
        _GT(typeof(GhostEffect2D)),
        _GT(typeof(GhostShadowXray)),
        _GT(typeof(GhostItem)),
        _GT(typeof(GhostShadowEffect)),
        _GT(typeof(FadInOut)),
        _GT(typeof(HighlightingSystem.HighlighterCore)),
        _GT(typeof(HighlightingSystem.Highlighter)),

        _GT(typeof(MainVersion)),

        _GT(typeof(GuidanceEventPenetrate)),
        _GT(typeof(CircleGuidanceController)),
        _GT(typeof(RectGuidanceController)),
