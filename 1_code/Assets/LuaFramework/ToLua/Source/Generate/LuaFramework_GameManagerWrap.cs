...
public class LuaFramework_GameManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetDebugMask", GetDebugMask);
		L.RegFunction("IsNetDebug", IsNetDebug);
		L.RegFunction("IsNetDetailDebug", IsNetDetailDebug);
		L.RegFunction("IsUpdDebug", IsUpdDebug);
		L.RegFunction("getLocalPath", getLocalPath);
		L.RegFunction("getConfigVersion", getConfigVersion);
		L.RegFunction("getRemoteGuideFileInfo", getRemoteGuideFileInfo);
		L.RegFunction("getEmbedChannel", getEmbedChannel);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetDebugMask(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.GameManager obj = (LuaFramework.GameManager)ToLua.CheckObject<LuaFramework.GameManager>(L, 1);
			int o = obj.GetDebugMask();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int IsNetDebug(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.GameManager obj = (LuaFramework.GameManager)ToLua.CheckObject<LuaFramework.GameManager>(L, 1);
			bool o = obj.IsNetDebug();
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int IsNetDetailDebug(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.GameManager obj = (LuaFramework.GameManager)ToLua.CheckObject<LuaFramework.GameManager>(L, 1);
			bool o = obj.IsNetDetailDebug();
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int IsUpdDebug(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.GameManager obj = (LuaFramework.GameManager)ToLua.CheckObject<LuaFramework.GameManager>(L, 1);
			bool o = obj.IsUpdDebug();
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int getEmbedChannel(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.GameManager obj = (LuaFramework.GameManager)ToLua.CheckObject<LuaFramework.GameManager>(L, 1);
			string o = obj.getEmbedChannel();
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch (Exception e)
