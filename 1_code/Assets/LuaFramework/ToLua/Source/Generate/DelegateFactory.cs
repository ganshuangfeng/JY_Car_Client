...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(HighlightingSystem.HighlighterCore.RendererFilter), factory.HighlightingSystem_HighlighterCore_RendererFilter);
		...
		DelegateTraits<HighlightingSystem.HighlighterCore.RendererFilter>.Init(factory.HighlightingSystem_HighlighterCore_RendererFilter);
		...
		TypeTraits<HighlightingSystem.HighlighterCore.RendererFilter>.Init(factory.Check_HighlightingSystem_HighlighterCore_RendererFilter);
		...
		StackTraits<HighlightingSystem.HighlighterCore.RendererFilter>.Push = factory.Push_HighlightingSystem_HighlighterCore_RendererFilter;
	}
	...
	public EventTriggerListener.VoidDelegate EventTriggerListener_VoidDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			EventTriggerListener.VoidDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.BaseEventData param1) { };
			return fn;
		}
	...
	class HighlightingSystem_HighlighterCore_RendererFilter_Event : LuaDelegate
	{
		public HighlightingSystem_HighlighterCore_RendererFilter_Event(LuaFunction func) : base(func) { }
		public HighlightingSystem_HighlighterCore_RendererFilter_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public bool Call(UnityEngine.Renderer param0, System.Collections.Generic.List<int> param1)
		{
			func.BeginPCall();
			func.Push(param0);
		...
		public bool CallWithSelf(UnityEngine.Renderer param0, System.Collections.Generic.List<int> param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public HighlightingSystem.HighlighterCore.RendererFilter HighlightingSystem_HighlighterCore_RendererFilter(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			HighlightingSystem.HighlighterCore.RendererFilter fn = delegate(UnityEngine.Renderer param0, System.Collections.Generic.List<int> param1) { return false; };
			return fn;
		}

		if(!flag)
		{
			HighlightingSystem_HighlighterCore_RendererFilter_Event target = new HighlightingSystem_HighlighterCore_RendererFilter_Event(func);
			HighlightingSystem.HighlighterCore.RendererFilter d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			HighlightingSystem_HighlighterCore_RendererFilter_Event target = new HighlightingSystem_HighlighterCore_RendererFilter_Event(func, self);
			HighlightingSystem.HighlighterCore.RendererFilter d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_HighlightingSystem_HighlighterCore_RendererFilter(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(HighlightingSystem.HighlighterCore.RendererFilter), L, pos);
	}

	void Push_HighlightingSystem_HighlighterCore_RendererFilter(IntPtr L, HighlightingSystem.HighlighterCore.RendererFilter o)
	{
		ToLua.Push(L, o);
	}
