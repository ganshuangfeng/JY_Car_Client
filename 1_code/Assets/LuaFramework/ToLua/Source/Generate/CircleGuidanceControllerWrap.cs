...
public class CircleGuidanceControllerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CircleGuidanceController), typeof(UnityEngine.MonoBehaviour));
	...
	static int SetTarget(IntPtr L)
	{
		try
		{
			...
			if (count == 3)
			{
				CircleGuidanceController obj = (CircleGuidanceController)ToLua.CheckObject<CircleGuidanceController>(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: CircleGuidanceController.SetTarget");
			}
		}
		catch (Exception e)
		{
	...
	static int get_Target(IntPtr L)
	{
		...
		try
		{
			...
			CircleGuidanceController obj = (CircleGuidanceController)o;
