...
public class DG_Tweening_TweenWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("PathGetWaypointIndexFromPerc", PathGetWaypointIndexFromPerc);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PathGetWaypointIndexFromPerc(IntPtr L)
	{
		try
		{
			...
			int o = obj.PathGetWaypointIndexFromPerc(arg0);
