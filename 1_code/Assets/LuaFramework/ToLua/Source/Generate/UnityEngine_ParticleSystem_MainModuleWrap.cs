...
public class UnityEngine_ParticleSystem_MainModuleWrap
{
	...
	static int set_simulationSpace(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem.MainModule obj = (UnityEngine.ParticleSystem.MainModule)o;
			UnityEngine.ParticleSystemSimulationSpace arg0 = (UnityEngine.ParticleSystemSimulationSpace)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_scalingMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem.MainModule obj = (UnityEngine.ParticleSystem.MainModule)o;
			UnityEngine.ParticleSystemScalingMode arg0 = (UnityEngine.ParticleSystemScalingMode)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_emitterVelocityMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem.MainModule obj = (UnityEngine.ParticleSystem.MainModule)o;
			UnityEngine.ParticleSystemEmitterVelocityMode arg0 = (UnityEngine.ParticleSystemEmitterVelocityMode)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_stopAction(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem.MainModule obj = (UnityEngine.ParticleSystem.MainModule)o;
			UnityEngine.ParticleSystemStopAction arg0 = (UnityEngine.ParticleSystemStopAction)LuaDLL.luaL_checknumber(L, 2);
			obj.stopAction = arg0;
			ToLua.SetBack(L, 1, obj);
			return 0;
		}
	...
	static int set_cullingMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem.MainModule obj = (UnityEngine.ParticleSystem.MainModule)o;
			UnityEngine.ParticleSystemCullingMode arg0 = (UnityEngine.ParticleSystemCullingMode)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_ringBufferMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.ParticleSystem.MainModule obj = (UnityEngine.ParticleSystem.MainModule)o;
			UnityEngine.ParticleSystemRingBufferMode arg0 = (UnityEngine.ParticleSystemRingBufferMode)LuaDLL.luaL_checknumber(L, 2);
