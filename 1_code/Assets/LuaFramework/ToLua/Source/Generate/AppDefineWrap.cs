...
public class AppDefineWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("CurEmbed", get_CurEmbed, set_CurEmbed);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_CurEmbed(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, AppDefine.CurEmbed);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_CurEmbed(IntPtr L)
	{
		try
		{
			string arg0 = ToLua.CheckString(L, 2);
			AppDefine.CurEmbed = arg0;
			return 0;
		}
		catch (Exception e)
		{
