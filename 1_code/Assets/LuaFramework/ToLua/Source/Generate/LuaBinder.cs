...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		ReplaceBakingMapWrap.Register(L);
		DrawMeshWrap.Register(L);
		ScreenRainWrap.Register(L);
		ScreenBrokenWrap.Register(L);
		GhostEffect2DWrap.Register(L);
		GhostShadowXrayWrap.Register(L);
		GhostItemWrap.Register(L);
		GhostShadowEffectWrap.Register(L);
		FadInOutWrap.Register(L);
		MainVersionWrap.Register(L);
		GuidanceEventPenetrateWrap.Register(L);
		CircleGuidanceControllerWrap.Register(L);
		RectGuidanceControllerWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		...
		L.BeginModule("Easing");
		DG_Tweening_Core_Easing_EaseManagerWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		L.EndModule();
		...
		LuaFramework_AudioManagerWrap.Register(L);
		...
		L.EndModule();
		L.BeginModule("HighlightingSystem");
		HighlightingSystem_HighlighterCoreWrap.Register(L);
		HighlightingSystem_HighlighterWrap.Register(L);
		L.BeginModule("HighlighterCore");
