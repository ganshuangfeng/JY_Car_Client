...
public class AutoDependencyChecker : EditorWindow
{
	...
	internal class doc_gl{
		public string move_path = "Assets/Game/GameCommon";
  ...
  //       // 一级资源
		// gl = new doc_gl ();
		// all_doc.Add ("Assets/Game/GameCommon", gl);

  //       gl = new doc_gl ();
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon"};
  ...
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/normal_ddz_common" };
  ...
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/normal_xxl_common" };
  ...
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/normal_fishing_common" };
  ...
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/normal_lhd_common" };
  ...
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/normal_mj_common" };
  ...
  //       gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/normal_qhb_common" };
  ...
  //       all_doc.Add ("Assets/Game/game_Login", gl);
        ...
        string[] dirs = Directory.GetDirectories("Assets/Game/GameModule");
		foreach(string dd in dirs)
        {
            gl = new doc_gl ();
			gl.paths = new List<string> (){"Assets/Game/GameCommon", "Assets/Game/game_Hall", "Assets/Game/GameModule/act_com"};
  ...
  {
    if (File.Exists (path1) && (!path1.Contains("Assets/Game/GameCommon") && !path1.Contains("Assets/Game/normal_base_common") && !path1.Contains("Assets/Game/GameModule/normal_gamemodule_common")))
    {
      return true;
    }
    return false;
    ...
    {
        string jj = "Assets/Game/GameCommon";
        string path = "Assets/Game/GameCommon/Material";
