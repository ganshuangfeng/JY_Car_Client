...
namespace LuaFramework {
    public class SDKManager : Manager {
		...
		public void PrepareAD(string codeID, string rewardName, int rewardAmount, string userID, string extraData, int width, int height, LuaFunction callback) {
			ADRewardMgr.Instance.PrepareAD(codeID, rewardName, rewardAmount, userID, extraData, width, height, callback);
		}

		public void PlayAD(string codeID, LuaFunction callback) {
			ADRewardMgr.Instance.PlayAD(codeID, callback);
		}
		...
		{
			ADRewardMgr.Instance.AddRewardVideoAdListener(RewardVideoAdListener, OnError,OnRewardVideoAdLoad,OnRewardVideoCached);
		}
		...
		{
			ADRewardMgr.Instance.AddRewardAdInteractionListener(RewardAdInteractionListener, 
																OnAdShowCallback,
		...
		public void RemoveRewardVideoAdListener(){
			ADRewardMgr.Instance.RemoveRewardVideoAdListener();
		}

		public void RemoveRewardAdInteractionListener(){
			ADRewardMgr.Instance.RemoveRewardAdInteractionListener();
		}

		public void ClearAD(string codeID) {
			ADRewardMgr.Instance.ClearAD(codeID);
		}

		public void ClearAllAD() {
			ADRewardMgr.Instance.ClearAllAD();
		}
