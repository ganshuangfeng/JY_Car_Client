...
class PostProcessBuilderMain : IPostprocessBuild {
	...
	private void PostprocessAndroid(string path) {
		...
		if (!string.IsNullOrEmpty(AppPredefine.MarketChannel) && AppPredefine.MarketChannel != "normal")
        {
			string configFile = copyRoot + "src/main/AndroidManifest_" + AppPredefine.MarketChannel + ".xml";
	...
	private void PostprocessIOS(string path) {
		...
		if (!string.IsNullOrEmpty(AppPredefine.MarketChannel) && AppPredefine.MarketChannel != "normal")
		{
			string configFile = copyRoot + "Info_" + AppPredefine.MarketChannel + ".plist";
			if (File.Exists(configFile)) {
