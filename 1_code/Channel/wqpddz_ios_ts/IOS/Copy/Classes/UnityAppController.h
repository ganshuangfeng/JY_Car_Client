...
@interface UnityAppController : NSObject<UIApplicationDelegate, WXApiDelegate, UNUserNotificationCenterDelegate, AVAudioRecorderDelegate, UIWebViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
