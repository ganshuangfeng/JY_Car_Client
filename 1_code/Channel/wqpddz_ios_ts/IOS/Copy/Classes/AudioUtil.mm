...
- (int) start0203814174214173;

- (BOOL) stopAudioRecord;
- (BOOL) stop0203814174214173;

- (int) playRecord:(NSString *)fileName;
- (int) play174214173:(NSString *)fileName;

- (void) stopPlayRecord;
- (void) stop1511024174214173;
...
+(int) start0203814174214173
{
    return [[AudioUtil getInstance] start0203814174214173];
}
...
+(BOOL) stop0203814174214173
{
    return [[AudioUtil getInstance] stop0203814174214173];
}
...
+(int) play174214173:(NSString *)fileName
{
	return [[AudioUtil getInstance] play174214173:fileName];
}
...
+(void) stop1511024174214173
{
    [[AudioUtil getInstance] stop1511024174214173];
}
...
- (int) play174214173:(NSString *)fileName
{
    ...
    NSData *data = [NSData dataWithContentsOfURL:fileURL];
    if(data == nil) {
		NSLog(@"play174214173 failed: load data failed: %@", fileName);
		return -1;
	}
    ...
    NSMutableData *output = [[NSMutableData alloc]init];
    if(![self decodeAmrData:output input:data]) {
		NSLog(@"play174214173 failed: decodeAmrData failed: %@", fileName);
        return -1;
	}
