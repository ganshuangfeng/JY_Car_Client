...
public class YSDKCallback implements UserListener, BuglyListener, PayListener, AntiAddictListener, AntiRegisterWindowCloseListener {
    ...
    public void OnLoginNotify(UserLoginRet ret) {
        Log.d("[YSDK]", "called");
        Log.d("[YSDK]", ret.getAccessToken());
        Log.d("[YSDK]", ret.getPayToken());
        Log.d("[YSDK]", "ret.flag" + ret.flag);
        Log.d("[YSDK]", ret.toString());

        SDKController.GetInstance().OnLoginNotify(ret);
...
//                break;
    ...
    public void OnWakeupNotify(WakeupRet ret) {
        Log.d("[YSDK]", "called");
        Log.d("[YSDK]", "flag:" + ret.flag);
        Log.d("[YSDK]", "msg:" + ret.msg);
        Log.d("[YSDK]", "platform:" + ret.platform);

        SDKController.GetInstance().OnWakeupNotify(ret);
    ...
    public void OnRelationNotify(UserRelationRet relationRet) {
        ...
        Log.d("[YSDK]", "OnRelationNotify" + builder.toString());
    ...
    public void OnPayNotify(PayRet ret) {
        Log.d("[YSDK]", ret.toString());
        SDKController.GetInstance().OnPayNotify(ret);
    ...
    public void onTimeLimitNotify(AntiAddictRet ret) {
        if (AntiAddictRet.RET_SUCC == ret.ret) {
            ...
            switch (ret.ruleFamily) {
                ...
                default:
                    SDKController.GetInstance().executeInstruction(ret);
                    break;
            }
        }
    }
    ...
    public void onWindowClose() {
        SDKController.GetInstance().showToastTips("请重新登录游戏");
    }
}
